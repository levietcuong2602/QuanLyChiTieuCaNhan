...
public class FragmentThongkeNam extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        dsHangmucThongkeChi = getAllHangmucNamChi();
        dsHangmucThongkeThu = getAllHangmucNamThu();
        setPhanTram();
        setAdapter();
    ...
    private ArrayList<HangmucThongke> getAllHangmucNamChi(){
    ...
    private ArrayList<HangmucThongke> getAllHangmucNamThu(){
